 ...
 * Slug: awforgtheme/general-cover-with-blurred-content-box
 * Categories: awforgtheme, awforgtheme-general
 */
?>
...
<div class="wp-block-cover alignfull has-parallax"
	...
	<div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-columns" style="margin-top:0;margin-bottom:0"><!-- wp:column -->
			...
			<!-- wp:column -->
			<div class="wp-block-column">
				<!-- wp:cover {"overlayColor":"background","minHeight":75,"minHeightUnit":"vh","contentPosition":"center center","isDark":false,"className":"is-style-awforgtheme-bg-blur","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","right":"var:preset|spacing|40","bottom":"var:preset|spacing|80","left":"var:preset|spacing|40"}}}} -->
				<div class="wp-block-cover is-light is-style-awforgtheme-bg-blur"
					...
					<div class="wp-block-cover__inner-container">
						...
						<div class="wp-block-group has-background-color has-text-color"
							...
							<h3 class="wp-block-heading has-heading-5-font-size">About AwfOrgTheme</h3>
							<!-- /wp:heading -->

							<!-- wp:paragraph -->
							<p>AwfOrgTheme is named after AwfOrgTheme National Park, which is located 200 km north of the Arctic
								circle in the Swedish province Lapland. It’s one of my favorite places on this earth.
							</p>
							<!-- /wp:paragraph -->

							<!-- wp:paragraph -->
							<p>I’m grateful for many things. One of the big ones is that I’ve been able to visit AwfOrgTheme
