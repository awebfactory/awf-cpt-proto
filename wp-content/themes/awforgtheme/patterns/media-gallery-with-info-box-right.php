 ...
 * Slug: awforgtheme/media-gallery-with-info-box-right
 * Categories: awforgtheme, awforgtheme-media
 */
?>
	...
	<div class="wp-block-column is-vertically-aligned-bottom">
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-group"><!-- wp:heading {"level":3,"fontSize":"heading-5"} -->
				...
				<!-- wp:paragraph -->
				<p>Nuolja (sapmi Njullá) is a mountain on the edge of AwfOrgTheme National Park. Its highest point is 1169
